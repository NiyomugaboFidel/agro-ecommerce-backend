...
var _require = require("../utils/bcrypt"),
  BcryptUtil = _require.BcryptUtil;
_passport["default"].use(new LocalStrategy({
  ...
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(email, password, done) {
    var foundUser, passwordMatches, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        ...
        case 2:
          _context.n = 3;
          return BcryptUtil.compare(password, foundUser.password);
        case 3:
          passwordMatches = _context.v;
          if (passwordMatches) {
            _context.n = 4;
            break;
          }
          return _context.a(2, done(null, false));
        case 4:
          return _context.a(2, done(null, foundUser));
        case 5:
          _context.p = 5;
          _t = _context.v;
