...
exports.registerUser = exports.checkToken = void 0;
...
var registerUser = exports.registerUser = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(data) {
    var firstname, lastname, email, phoneNumber, password, newUser, _t, _t2, _t3, _t4, _t5, _t6, _t7;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          ...
          _t5 = phoneNumber;
          _context.n = 1;
          return _bcryptjs.BcryptUtil.hash(password);
        case 1:
          _t6 = _context.v;
          _t7 = {
            firstname: _t2,
          ...
          _context.n = 2;
          return _t.create.call(_t, _t7);
        case 2:
          newUser = _context.v;
          return _context.a(2, newUser);
      }
    }, _callee);
  }));
...
var checkToken = exports.checkToken = function checkToken(token, env) {
  var payload = _jsonwebtoken["default"].verify(token, env, function (error, decodedToken) {
    if (error) {
      return error;
    }
    return decodedToken;
